--[[
	AGGRESSIVE GamepassHandler with Direct Communication
	This version implements proper client-side listening and aggressive cleanup
]]
						...
						if rootPart then
							...
							for _, part in ipairs(parts) do
								...
								if part:IsA("BasePart") then
									...
									-- Material check - common effect materials
